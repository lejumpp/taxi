...
public class Main extends Application {
 ...
 public void CreateMember() {
    ...
    public void CustomerService() {
    	...
    	GridPane.setConstraints(queryT,2,4);
    ...
    public void ManagerLogin() {
    	...
    	Text text1 = new Text("RCHIE CABS");
    	text1.setFont(f);
    	GridPane.setConstraints(text1,0,0);
    	Label name= new Label("User name");
    	GridPane.setConstraints(name, 0, 1);
    ...
    public void showMenu() {
    	...
    	Label label2 = new Label("RICHIE AI");
    	Label label3 = new Label("Main Menu");
    ...
    public void AddCab() {
    	...
    	Label AI = new Label("RICHIE AI");
    	Label ADc = new Label ("ADD CAB");
    	...
    	submit.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
               ...
               int x= addcab.add(new Taxi(0,name.getText(),name.getText(),trn.getText(),(new Vehicle(model.getText(),year.getText()))));
                if(x==1) {System.out.println("record added");}////PUT THEPOP UP PANE
               stage2.close();
